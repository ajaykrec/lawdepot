...
const MyAccountNavBar = () => {
    ...
    const invoices_menu         = ['my-invoices']; 
    ...
    return (
        ...
        <div className="my-account-navbar d-grid gap-1 pb-5">            
            ...
            <Link href={ route('customer.invoices') }  className={`btn btn-very-small ${invoices_menu.includes(current_path) ? 'present' : ''}`}>My Invoices</Link>
