        ...
        <div className="row">
            ...
            {parseWithLinks(''+pageData.page.content+'')}
              ...
              <div className="text-center pt-5">
              {
                ...
                <h6><b>{ allFunction.currency(membership.price,country.code) }</b></h6>
                <form action="https://secure.nochex.com/" method="post" name="nochexForm">
                  <input type="hidden" name="merchant_id" value="Recurring@instantly.legal" />
                ...
                <p className="p-2">
                By selecting Place Secure Order, you agree to the <Link href={ route('terms') } style={{color:"rgb(19 111 254)"}}><b>Terms of Use</b></Link>.
                </p>
                </>
                :                
                <p className="p-2">
