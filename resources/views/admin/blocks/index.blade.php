...
@section('page-content')
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row my-3">
                            ...
                            <form id="filterForm" name="filterForm" method="get" action="{{ route('blocks.index') }}"> 
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                <div class="mb-2">
                                <input type="text" class="form-control" id="identity" name="identity" value="{{ $identity ?? '' }}" placeholder="Identity">                                
                                </div>  
                                </div> 
                            ...
                            <div class="col-lg-2 col-md-12 col-12">
                                <div class="text-end">
                                <a href="{{ route('blocks.create') }}" class="btn btn-secondary">+ Add New</a>
                                </div>
                            </div>    
                            @endif                     
                        </div>                       
                        
                        <form id="applyForm" name="applyForm" method="post" action="{{ route('blocks.index') }}" >  
                        @csrf
                        ...
                        <table class="table table-hover table-striped">                            
                            ...
                            <tbody>
                                @if($results)
                                    ...
                                    <tr id="row-{{ $val['block_id'] }}">
                                        <td><input class="form-check-input selected-chk" type="checkbox" name="id[]" value="{{ $val['block_id'] }}"></td>
                                        <td>{{ $start_count }}</td>
                                        <td>{{ $val['title'] }}</td>   
                                        <td>{{ $val['identity'] }}</td>                                     
                                        <td>
    ...
    const delete_row = (id) =>{  
        ...
        swal({		  
            ...
            var url = "{{ route('blocks.destroy','id') }}"
