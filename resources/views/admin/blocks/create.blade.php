    ...
    <section class="section dashboard">
        <div class="row">
            <div class="col-lg-8">               
                ...
                <form id="dataForm" name="dataForm" method="post" action="{{ route('blocks.store')}}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="tab-content pt-2" id="borderedTabJustifiedContent">
                    ...
                    <div class="tab-pane fade my-3" id="bordered-justified-{{ $val['code'] }}" role="tabpanel" aria-labelledby="{{ $val['code'] }}-tab">
                        ...
                        <input type="text" class="form-control" name="title[{{ $language_id }}]" value="{{ old('title')[$language_id] ?? '' }}"> 
                        ...
                        <textarea class="form-control tinymce-editor" name="description[{{ $language_id }}]" style="height: 100px">{{ old('description')[$language_id] ?? '' }}</textarea>
