...
@section('page-content')
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row my-3">
                            ...
                            <form id="filterForm" name="filterForm" method="get" action="{{ route('document-category.index') }}"> 
                            <div class="row">
                            ...
                            <div class="col-lg-2 col-md-12 col-12">
                                <div class="text-end">
                                <a href="{{ route('document-category.create') }}" class="btn btn-secondary">+ Add New</a>
                                </div>
                            </div>   
                            @endif                      
                        </div>                       
                        
                        <form id="applyForm" name="applyForm" method="post" action="{{ route('document-category.index') }}" >  
                        @csrf
                        ...
                        <table class="table table-hover table-striped">                            
                            ...
                            <tbody>
                                @if($results)
                                    ...
                                    <tr id="row-{{ $val['category_id'] }}">
                                        <td><input class="form-check-input selected-chk" type="checkbox" name="id[]" value="{{ $val['category_id'] }}"></td>
                                        <td>{{ $start_count }}</td>
                                        <td>{{ $val['name'] }}</td>   
                                        <td>{{ $val['slug'] }}</td>  
                                        ...
                                        <td class="text-end">
                                            ...
                                            <a href="{{ route('document-category.edit',$val['category_id']) }}" class="btn btn-md" title="Edit"><i class="bi bi-pencil-square text-success"></i></a>

                                            <button type="button" class="btn btn-md delete"                                             
                                            onclick="delete_row({{ $val['category_id'] }})"                
    ...
    const delete_row = (id) =>{
        ...
        swal({		  
            ...
            var url = "{{ route('document-category.destroy','id') }}"
