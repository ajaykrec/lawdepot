    ...
    @csrf            
        <div class="row">
            ...
            <div class="col-lg-6 col-12">               
                ...
                <textarea class="form-control" name="openai_system_content" style="height: 150px">{{ old('openai_system_content', $data['openai_system_content'] ?? '') }}</textarea>
                ...
                <textarea class="form-control" name="openai_user_content" style="height: 150px">{{ old('openai_user_content', $data['openai_user_content'] ?? '') }}</textarea>
