                            ...
                            <tbody>
                                @if($results)
                                    ...
                                    <tr id="row-{{ $val['customer_id'] }}">
                                        ...
                                        <td class="text-end">
                                            <a href="{{ route('customers.show',$val['customer_id']) }}" class="btn btn-md" title="View"><i class="bi bi-columns-gap text-secondary"></i></a>

                                            @if(has_permision(['customers'=>'RW']))
                                            <a href="{{ route('customers.edit',$val['customer_id']) }}" class="btn btn-md" title="Edit"><i class="bi bi-pencil-square text-success"></i></a>
                                            <button type="button" class="btn btn-md delete" onclick="delete_row({{ $val['customer_id'] }})"          title="Delete"><i class="bi bi-trash text-danger"></i></button>
                                            @endif
                                        </td>
                                    </tr> 
