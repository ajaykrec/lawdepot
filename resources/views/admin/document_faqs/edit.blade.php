    ...
    <section class="section dashboard">
        <div class="row">
            <div class="col-lg-8">               
                ...
                <form id="dataForm" name="dataForm" method="post" action="{{ route('faqs.update',$dfaq_id) }}" enctype="multipart/form-data">
                @method('PUT')
                @csrf                
                ...
                <textarea  class="form-control tinymce-editor" rows="10" id="answer" name="answer">{{ old('answer', $data['answer'] ?? '') }}</textarea> 
