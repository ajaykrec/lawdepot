    ...
    <section class="section dashboard">
        <div class="row">
            <div class="col-lg-8">               
                ...
                <form id="dataForm" name="dataForm" method="post" action="{{ route('faq.store')}}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="tab-content pt-2" id="borderedTabJustifiedContent">
                    ...
                    <div class="tab-pane fade my-3" id="bordered-justified-{{ $val['code'] }}" role="tabpanel" aria-labelledby="{{ $val['code'] }}-tab">
                        ...
                        <input type="text" class="form-control" name="question[{{ $language_id }}]" value="{{ old('question')[$language_id] ?? '' }}"> 
                        ...
                        <textarea class="form-control tinymce-editor" name="answer[{{ $language_id }}]" style="height: 100px">{{ old('answer')[$language_id] ?? '' }}</textarea>
