                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row my-3">
                            ...
                            <form id="filterForm" name="filterForm" method="get" action="{{ route('faq.index') }}"> 
                            <div class="row">
                        ...
                        <form id="applyForm" name="applyForm" method="post" action="{{ route('faq.index') }}" >  
                        @csrf
                        ...
                        <table class="table table-hover table-striped">                            
                            ...
                            <tbody>
                                @if($results)
                                    ...
                                    <tr id="row-{{ $val['faq_id'] }}">
                                        <td><input class="form-check-input selected-chk" type="checkbox" name="id[]" value="{{ $val['faq_id'] }}"></td>
                                        <td>{{ $start_count }}</td>
                                        <td>{{ $val['question'] }}</td>                                    
                                        <td>
                                            @if($val['status'] == '1')                                                
                                        ...
                                        <td class="text-end">                                            
                                            ...
                                            @if(has_permision(['faq'=>'RW']))
                                            <a href="{{ route('faq.edit',$val['faq_id']) }}" class="btn btn-md" title="Edit"><i class="bi bi-pencil-square text-success"></i></a>
                                            <button type="button" class="btn btn-md delete"                                             
                                            onclick="delete_row({{ $val['faq_id'] }})"                         
