...
@section('page-content')
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('banner-category.index') }}">Banners Category</a></li>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row my-3">
                            ...
                            <form id="filterForm" name="filterForm" method="get" action="{{ route('banner-category.banners.index',$bannercat_id) }}"> 
                            <div class="row">
                            ...
                            <div class="col-lg-2 col-md-12 col-12">
                                <div class="text-end">
                                <a href="{{ route('banner-category.banners.create',$bannercat_id) }}" class="btn btn-secondary">+ Add New</a>
                                </div>
                            </div>   
                            @endif                      
                        </div>                       
                        
                        <form id="applyForm" name="applyForm" method="post" action="{{ route('banner-category.banners.index',$bannercat_id) }}">  
                        @csrf
                        ...
                        <table class="table table-hover table-striped">                            
                            ...
                            <tbody>
                                @if($results)
                                    ...
                                    <tr id="row-{{ $val['banner_id'] }}">
                                        <td><input class="form-check-input selected-chk" type="checkbox" name="id[]" value="{{ $val['banner_id'] }}"></td>
                                        <td>{{ $start_count }}</td>
                                        <td>
                                        @if($val['banner_image'])  
                                        ...
                                        <td class="text-end">  
                                            ...
                                            @if(has_permision(['banners'=>'RW']))
                                            <a href="{{ route('banners.edit',$val['banner_id']) }}" class="btn btn-md" title="Edit"><i class="bi bi-pencil-square text-success"></i></a>
                                            <button 
                                            type="button" 
                                            class="btn btn-md delete"  
                                            onclick="delete_row({{ $val['banner_id'] }})"                                                          
    ...
    const delete_row = (id) =>{
        ...
        swal({		  
            ...
            var url = "{{ route('banners.destroy','id') }}"
